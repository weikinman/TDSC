 ...
 * @constant
 */
TDSC.Tween.Linear = function(t,b,c,d){ return c*t/d + b; }
/**
 * 补间算法类型——Quad
 * 算法来自：http://www.robertpenner.com/easing/
 * @constant
...
TDSC.Tween.Bounce = {
	In: function(t,b,c,d){
		return c - TDSC.Tween.Bounce.Out(d-t, 0, c, d) + b;
	},
	Out: function(t,b,c,d){
		if ((t/=d) < (1/2.75)) {
	...
	InOut: function(t,b,c,d){
		if (t < d/2) return TDSC.Tween.Bounce.In(t*2, 0, c, d) * .5 + b;
		else return TDSC.Tween.Bounce.Out(t*2-d, 0, c, d) * .5 + c*.5 + b;
	}
}
